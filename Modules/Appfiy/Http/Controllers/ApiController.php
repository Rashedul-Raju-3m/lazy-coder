...
//                    ->join('appfiy_theme_config','appfiy_theme_config.theme_id','=','appfiy_theme.id')
                ...
                if ($data){
                    foreach ($data['globalConfig'] as $config){
                        if (isset($config['mode']) && !empty($config['mode'])) {
                            $configData = DB::table('appfiy_global_config')->where('mode', $config['mode'])->get()->toArray();
                            /*if ($data['globalConfig']['mode'] == $config['mode']){
                                $data['globalConfig'][$config['mode']] = $configData;
                            }*/
                        }
                        $config[$config['mode'].'_theme'] = $configData;
                    }
                }
//                dd($data);
//                dd($data['globalConfig'][mode])
...
//                                    'appfiy_theme_component.component_parent_id',
                                    ...
                                    ->whereNull('appfiy_theme_component.component_parent_id')
