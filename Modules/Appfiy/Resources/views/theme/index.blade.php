            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-header">
                        ...
                        <h6>{{__('appfiy::messages.themeList')}}</h6>
                        <div class="btn-toolbar mb-2 mb-md-0">
                            <div class="btn-group me-2">
                                <a href="{{route('theme_add', app()->getLocale())}}" title="" class="module_button_header">
                        ...
                        <form method="post" role="form" id="search-form">
                            <table id="leave_settings" class="table table-bordered datatable table-responsive mainTable text-center">
                                ...
                                <tr>
                                    ...
                                    <th>{{__('appfiy::messages.appbarName')}}</th>
                                    <th>{{__('appfiy::messages.navbarName')}}</th>
                                    <th>{{__('appfiy::messages.drawerName')}}</th>
                                    ...
                                    <tbody>
                                        ...
                                        @foreach($themes as $theme)
                                            <tr>
                                                ...
                                                <td>{{$theme['appbar']->appbar_name}}</td>
                                                <td>{{$theme['navbar']->navbar_name}}</td>
                                                <td>{{$theme['drawer']->drawer_name}}</td>
                                                <td>
