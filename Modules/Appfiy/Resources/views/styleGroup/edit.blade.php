            ...
            <div class="col-md-12">
                <div class="card">
                            ...
                            <div class="btn-toolbar mb-2 mb-md-0">
                                <div class="btn-group me-2">
                                   ...
                                   {{-- <a href="{{route('component_add', app()->getLocale())}}" title="" class="module_button_header">
                                    ...
                                    <a href="{{route('style_group_list', app()->getLocale())}}" title="" class="module_button_header">
                                        <button type="button" class="btn btn-sm btn-outline-secondary">
                                            <i class="fas fa-list"></i> {{__('appfiy::messages.styleGroupList')}}
                                        </button>
                                    </a>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                {!! Form::model($styleGroup, ['method' => 'PATCH','autocomplete'=>'off', 'files'=> true, 'route'=> ['style_group_properties_update',app()->getLocale(), $styleGroup->id],'enctype'=>'multipart/form-data']) !!}

                                <div class="row">

                                    <div class="form-group row mg-top">
                                        <div class="col-sm-2">
                                            {!! Form::label(__('appfiy::messages.styleProperties'), __('appfiy::messages.styleProperties'), array('class' => 'form-label','for'=>'formFile')) !!}
